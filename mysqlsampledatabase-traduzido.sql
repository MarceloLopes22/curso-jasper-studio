...
Version 3.1
+ changed data type from DOUBLE to DECIMAL for valor columns
Version 3.0
...
CREATE TABLE `clientes` (
  ...
  `ultimoNomeContato` varchar(50) NOT NULL,
  `primeiroNomeContato` varchar(50) NOT NULL,
  ...
  `numeroFuncionarioRepVendas` int(11) DEFAULT NULL,
  `creditoLimite` decimal(10,2) DEFAULT NULL,
  PRIMARY KEY (`numeroCliente`),
  KEY `numeroFuncionarioRepVendas` (`numeroFuncionarioRepVendas`),
  CONSTRAINT `customers_ibfk_1` FOREIGN KEY (`numeroFuncionarioRepVendas`) REFERENCES `funcionarios` (`numeroFuncionario`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `clientes` */

insert  into `clientes`(`numeroCliente`,`nomeCliente`,`ultimoNomeContato`,`primeiroNomeContato`,`telefone`,`endereco1`,`endereco2`,`cidade`,`estado`,`cep`,`pais`,`numeroFuncionarioRepVendas`,`creditoLimite`) values 
...
CREATE TABLE `funcionarios` (
  ...
  `codigoEscritorio` varchar(10) NOT NULL,
  `reportarPara` int(11) DEFAULT NULL,
  `tituloCargo` varchar(50) NOT NULL,
  PRIMARY KEY (`numeroFuncionario`),
  KEY `reportarPara` (`reportarPara`),
  KEY `codigoEscritorio` (`codigoEscritorio`),
  CONSTRAINT `employees_ibfk_1` FOREIGN KEY (`reportarPara`) REFERENCES `funcionarios` (`numeroFuncionario`),
  CONSTRAINT `employees_ibfk_2` FOREIGN KEY (`codigoEscritorio`) REFERENCES `escritorios` (`codigoEscritorio`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `funcionarios` */

insert  into `funcionarios`(`numeroFuncionario`,`ultimoNome`,`primeiroNome`,`extensao`,`email`,`codigoEscritorio`,`reportarPara`,`tituloCargo`) values 
...
insert  into `escritorios`(`codigoEscritorio`,`cidade`,`telefone`,`endereco1`,`endereco2`,`estado`,`pais`,`cep`,`territorio`) values 
...
CREATE TABLE `detalhePedido` (
  ...
  CONSTRAINT `orderdetails_ibfk_2` FOREIGN KEY (`codigoProduto`) REFERENCES `produtos` (`codigoProduto`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `detalhePedido` */

insert  into `detalhePedido`(`numeroPedido`,`codigoProduto`,`quantidadePedida`,`precoUnitario`,`numeroLinhaPedido`) values 
...
CREATE TABLE `pedidos` (
  ...
  CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`numeroCliente`) REFERENCES `clientes` (`numeroCliente`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `pedidos` */

insert  into `pedidos`(`numeroPedido`,`dataPedido`,`dataExigida`,`dataEnviada`,`status`,`comentarios`,`numeroCliente`) values 
...
CREATE TABLE `pagamentos` (
  `numeroCliente` int(11) NOT NULL,
  `numeroConferencia` varchar(50) NOT NULL,
  `dataPagamento` date NOT NULL,
  `valor` decimal(10,2) NOT NULL,
  PRIMARY KEY (`numeroCliente`,`numeroConferencia`),
  CONSTRAINT `payments_ibfk_1` FOREIGN KEY (`numeroCliente`) REFERENCES `clientes` (`numeroCliente`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `pagamentos` */

insert  into `pagamentos`(`numeroCliente`,`numeroConferencia`,`dataPagamento`,`valor`) values 
...
/*Table structure for table `linhaProdutos` */

DROP TABLE IF EXISTS `linhaProdutos`;

CREATE TABLE `linhaProdutos` (
  `linhaProduto` varchar(50) NOT NULL,
  `descricao` varchar(4000) DEFAULT NULL,
  `descricaoHtml` mediumtext,
  `imagem` mediumblob,
  PRIMARY KEY (`linhaProduto`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `linhaProdutos` */

insert  into `linhaProdutos`(`linhaProduto`,`descricao`,`descricaoHtml`,`imagem`) values 
...
CREATE TABLE `produtos` (
  ...
  `quantidadeEmEstoque` smallint(6) NOT NULL,
  `precoDeCompra` decimal(10,2) NOT NULL,
  `MSRP` decimal(10,2) NOT NULL,
  PRIMARY KEY (`codigoProduto`),
  KEY `linhaProduto` (`linhaProduto`),
  CONSTRAINT `products_ibfk_1` FOREIGN KEY (`linhaProduto`) REFERENCES `linhaProdutos` (`linhaProduto`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `produtos` */

insert  into `produtos`(`codigoProduto`,`nomeProduto`,`linhaProduto`,`escalaProduto`,`fornecedorProduto`,`descricaoProduto`,`quantidadeEmEstoque`,`precoDeCompra`,`MSRP`) values 
